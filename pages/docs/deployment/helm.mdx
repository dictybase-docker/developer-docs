...
We use [Helm charts](https://helm.sh/docs/topics/charts/) to deploy our software.

## Upgrade Helm

It is recommended to upgrade `Helm (v2)` to its latest version. As of this
writing upgrade Helm to
[v2.17.0](https://github.com/helm/helm/releases/tag/v2.17.0). After the
